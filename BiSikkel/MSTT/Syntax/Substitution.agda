...
module BiSikkel.MSTT.Syntax.Substitution
...
open BiSikkel.MSTT.Parameter.TermExtension ℳ 𝒯 hiding (TmExt)
open import BiSikkel.MSTT.Syntax.Types ℳ 𝒯
open import BiSikkel.MSTT.Syntax.Contexts ℳ 𝒯
open import BiSikkel.MSTT.Syntax.Terms ℳ 𝒯 𝓉 hiding (refl)
