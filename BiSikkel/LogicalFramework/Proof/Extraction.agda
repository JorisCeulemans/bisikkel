...
module BiSikkel.LogicalFramework.Proof.Extraction
  (ℬ : BiSikkelParameter)
  where
...
open import BiSikkel.MSTT 𝒫 hiding (refl)
...
open import BiSikkel.LogicalFramework.Proof.Definition ℬ using (Proof)
open import BiSikkel.LogicalFramework.Proof.Checker.ResultType 𝒫 𝒷 ⟦𝒷⟧
open import BiSikkel.LogicalFramework.Proof.Checker ℬ
