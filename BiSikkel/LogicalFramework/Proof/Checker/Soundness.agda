...
module BiSikkel.LogicalFramework.Proof.Checker.Soundness
...
open import BiSikkel.Model.DRA as DRA hiding (⟨_∣_⟩; 𝟙; _,lock⟨_⟩; TwoCell; id-cell)
import BiSikkel.Model.Type.Dependent.Identity as M
import BiSikkel.Model.Type.Dependent.Identity.Modal as M
import BiSikkel.Model.Type.Dependent.Constant as M
import BiSikkel.Model.Type.Dependent.Function as M renaming (lam to dlam)
...
open import BiSikkel.MSTT.Soundness.Variable ℳ 𝒯 𝓉 ⟦𝓉⟧
open import BiSikkel.LogicalFramework.bProp 𝒫 𝒷 ⟦𝒷⟧
open import BiSikkel.LogicalFramework.bProp.Soundness.Substitution 𝒫 𝒷 ⟦𝒷⟧
