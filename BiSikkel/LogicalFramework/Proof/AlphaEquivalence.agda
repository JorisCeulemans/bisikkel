...
module BiSikkel.LogicalFramework.Proof.AlphaEquivalence
...
open import BiSikkel.Preliminaries -- we need uip for term extension equivalence

open import BiSikkel.MSTT.Parameter.TermExtension ℳ 𝒯
open TmExt 𝓉
open import BiSikkel.MSTT.Parameter.TermExtensionSemantics ℳ 𝒯
open TmExtSem ⟦𝓉⟧
