...
open import Applications.NonModal.BiSikkel
open import BiSikkel.MSTT triv-mstt
open import BiSikkel.LogicalFramework triv-param

open import BiSikkel.Model.BaseCategory hiding (★; ω)
