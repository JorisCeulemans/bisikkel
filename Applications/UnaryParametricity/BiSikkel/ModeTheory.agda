...
open import BiSikkel.Model.BaseCategory as M hiding (★; ↑)
open import BiSikkel.Model.CwF-Structure as M using (eq)
open import BiSikkel.Model.DRA as DRA hiding (⟨_∣_⟩; 𝟙; _,lock⟨_⟩; TwoCell; id-cell; _ⓣ-vert_; _ⓣ-hor_)
